...
- требуется нужно  использовать дисковое пространство за счёт выделения томов по требованию (режим Thin).
...
- не рекомендуется использовать другие решения SDS (Software Defined Storage) для предоставления дисков SDS Deckhouse.
